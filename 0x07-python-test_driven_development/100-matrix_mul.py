#!/usr/bin/python3
"""Defining a function that does Matrix multiplication."""
...
def matrix_mul(m_a, m_b):
    ...
    Raises:
        TypeError: If eithe m_a or m_b is not a list of lists of int/float.
        TypeError: If either m_a or m_b is empty.
        TypeError: If either m_a or m_b has rows of different sizes.
        ValueError: If m_a or m_b can't be multiplied.
    Returns:
        A new matrix containing the result of multiplying m_a and m_b.
    """
